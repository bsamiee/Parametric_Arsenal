...
public static class GeometryGenerators {
    ...
    [Pure]
    public static Gen<Vector3d> Vector3dGen =>
    ...
    [Pure]
    public static Gen<PolylineCurve> PolylineCurveGen =>
    ...
    [Pure]
    public static Gen<int> DivisionCountGen => Gen.OneOfConst(DivisionCounts);

    /// <summary>Generates valid division lengths based on typical curve lengths.</summary>
    [Pure]
    public static Gen<double> DivisionLengthGen => Gen.Double[0.5, 10.0].Where(static d => d > RhinoMath.ZeroTolerance);

    /// <summary>Generates valid angle thresholds for feature edge detection (radians).</summary>
    [Pure]
    public static Gen<double> AngleThresholdGen => Gen.Double[RhinoMath.ToRadians(10.0), RhinoMath.ToRadians(60.0)];

    /// <summary>Generates valid isocurve counts.</summary>
    [Pure]
    public static Gen<int> IsocurveCountGen => Gen.Int[2, 20];
}

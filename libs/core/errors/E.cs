...
/// <list type="bullet">
/// <item>1000-1199: Results system errors</item>
...
/// <para>Error domain is automatically computed from code range, eliminating need for separate domain configuration.</para>
///
/// <para><b>Usage:</b></para>
/// <code>
...
public static class E {
    ...
    public static SystemError Get(int code, string? context = null) {
        ...
        return context switch {
            null => new(domain: domain, code: code, message: message),

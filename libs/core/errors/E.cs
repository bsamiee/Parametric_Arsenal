...
public static class E {
    private static readonly FrozenDictionary<int, string> _m =
        new Dictionary<int, string> {
            ...
            [3910] = "Polycurve has segment gaps exceeding tolerance",
            [3911] = "Polycurve segment continuity insufficient",
            [3912] = "Polycurve segment count invalid",
            [3913] = "Polycurve has duplicate consecutive segments",
            [3940] = "NURBS control point count below minimum",
            [3941] = "NURBS knot vector invalid",
            [3942] = "NURBS degree exceeds valid bounds",
            [3943] = "NURBS has duplicate control points",
            [3950] = "Extrusion profile curve invalid",
            [3951] = "Extrusion path direction invalid",
            [3952] = "Extrusion has degenerate cap",
            [3960] = "Surface UV domain has singularity",
            [3961] = "Surface UV domain invalid or degenerate",
            [3962] = "Surface parameter out of domain bounds",
    ...
    public static class Validation {
        ...
        public static readonly SystemError PolycurveGaps = Get(3910);
        public static readonly SystemError PolycurveContinuity = Get(3911);
        public static readonly SystemError PolycurveSegmentCount = Get(3912);
        public static readonly SystemError PolycurveDuplicateSegments = Get(3913);
        public static readonly SystemError NurbsControlPointCount = Get(3940);
        public static readonly SystemError NurbsKnotVector = Get(3941);
        public static readonly SystemError NurbsDegree = Get(3942);
        public static readonly SystemError NurbsDuplicateControlPoints = Get(3943);
        public static readonly SystemError ExtrusionProfileInvalid = Get(3950);
        public static readonly SystemError ExtrusionPathInvalid = Get(3951);
        public static readonly SystemError ExtrusionDegenerateCap = Get(3952);
        public static readonly SystemError UVDomainSingularity = Get(3960);
        public static readonly SystemError UVDomainInvalid = Get(3961);
        public static readonly SystemError UVParameterOutOfBounds = Get(3962);

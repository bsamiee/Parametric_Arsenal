...
public readonly record struct SystemError(byte Domain, int Code, string Message) {
    ...
    [Pure] public override string ToString() => $"[{this.Domain switch { E.ResultsDomain => "Results", E.GeometryDomain => "Geometry", E.ValidationDomain => "Validation", E.SpatialDomain => "Spatial", E.TopologyDomain => "Topology", _ => "Unknown" }}:{this.Code}] {this.Message}";

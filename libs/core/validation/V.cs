...
/// bool hasStandard = mode.Has(flag: V.Standard);  // true
/// bool hasArea = mode.Has(flag: V.AreaCentroid);  // false
/// </code>
/// 
...
public readonly struct V(ushort flags) : IEquatable<V> {
    ...
    public static readonly V All = new(flags: (ushort)(
    ...
    public static V operator |(V left, V right) => new(flags: (ushort)(left._flags | right._flags));
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Has(V flag) =>
        flag._flags == 0
            ? this._flags == 0
            : (this._flags & flag._flags) == flag._flags;

    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static V BitwiseOr(V left, V right) => left | right;

    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static V BitwiseAnd(V left, V right) => left & right;
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ushort ToUInt16() => this._flags;

    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static V FromUInt16(ushort value) => new(flags: value);

...
/// <summary>Internal topology computation engine with all algorithms fully inlined for maximum density.</summary>
internal static class TopologyEngine {
    ...
    internal static Result<NakedEdgeData> ExecuteNakedEdges<T>(
        ...
        UnifiedOperation.Apply(
            ...
            config: new OperationConfig<T, NakedEdgeData> {
                Context = context,
                ValidationMode = TopologyConfig.ValidationModes.TryGetValue(typeof(T), out V mode) ? mode : V.None,
    ...
    internal static Result<BoundaryLoopData> ExecuteBoundaryLoops<T>(
        ...
        UnifiedOperation.Apply(
            input: input,
            operation: (Func<T, Result<IReadOnlyList<BoundaryLoopData>>>)(g => (g, tolerance ?? context.AbsoluteTolerance) switch {
                (Brep brep, double tol) => ((Func<Result<IReadOnlyList<BoundaryLoopData>>>)(() => {
                ...
                (Mesh mesh, double tol) => ((Func<Result<IReadOnlyList<BoundaryLoopData>>>)(() => {
    ...
    internal static Result<NonManifoldData> ExecuteNonManifold<T>(
        ...
        UnifiedOperation.Apply(
            ...
            operation: (Func<T, Result<IReadOnlyList<NonManifoldData>>>)(g => g switch {
                Brep brep => ((Func<Result<IReadOnlyList<NonManifoldData>>>)(() => {
                ...
                Mesh mesh => ((Func<Result<IReadOnlyList<NonManifoldData>>>)(() => {
    ...
    internal static Result<ConnectivityData> ExecuteConnectivity<T>(
        ...
        UnifiedOperation.Apply(
            ...
            operation: (Func<T, Result<IReadOnlyList<ConnectivityData>>>)(g => g switch {
                Brep brep => ((Func<Result<IReadOnlyList<ConnectivityData>>>)(() => {
                ...
                Mesh mesh => ((Func<Result<IReadOnlyList<ConnectivityData>>>)(() => {
    ...
    internal static Result<EdgeClassificationData> ExecuteEdgeClassification<T>(
        ...
        UnifiedOperation.Apply(
            input: input,
            operation: (Func<T, Result<IReadOnlyList<EdgeClassificationData>>>)(g => (g, minimumContinuity ?? Continuity.G1_continuous, angleThreshold ?? context.AngleToleranceRadians) switch {
                (Brep brep, Continuity minContinuity, double angleTol) => ((Func<Result<IReadOnlyList<EdgeClassificationData>>>)(() => {
                    ...
                    IReadOnlyList<EdgeContinuity> classifications = [.. edgeIndices.Select(i => {
                        ...
                        return edge.Valence switch {
                            ...
                            EdgeAdjacency.Interior => edge.EdgeCurve switch {
                                ...
                                Curve crv when edge.IsSmoothManifoldEdge(angleToleranceRadians: angleTol) || crv.IsContinuous(continuityType: Continuity.G1_continuous, t: crv.Domain.Mid) || crv.IsContinuous(continuityType: Continuity.G1_locus_continuous, t: crv.Domain.Mid) => EdgeContinuity.Smooth,
                    ...
                    FrozenDictionary<EdgeContinuity, IReadOnlyList<int>> grouped = edgeIndices
                        ...
                        .GroupBy(x => x.type.Kind, x => x.idx)
                        .ToFrozenDictionary(g => new EdgeContinuity(g.Key), g => (IReadOnlyList<int>)[.. g,]);
                ...
                (Mesh mesh, _, double angleTol) => ((Func<Result<IReadOnlyList<EdgeClassificationData>>>)(() => {
                    double curvatureThreshold = angleTol * TopologyConfig.CurvatureThresholdFactor;
                    ...
                    IReadOnlyList<EdgeContinuity> classifications = [.. edgeIndices.Select(i => {
                        ...
                        return connectedFaces.Length switch {
                            ...
                            2 => ((Func<double>)(() => {
                                ...
                                double angle when Math.Abs(angle) < angleTol => EdgeContinuity.Smooth,
                                _ => EdgeContinuity.Sharp,
                            },
                            _ => EdgeContinuity.Sharp,
                        };
        ...
        UnifiedOperation.Apply(
            ...
            operation: (Func<T, Result<IReadOnlyList<AdjacencyData>>>)(g => g switch {
                Brep brep => edgeIndex >= 0 && edgeIndex < brep.Edges.Count
                    ? ((Func<Result<IReadOnlyList<AdjacencyData>>>)(() => {

        ...
        !brep.IsValidTopology(out string _)
            ...
            : ResultFactory.Create(value: brep)
                ...
                .Bind(data => data switch {
                    (int v, int e, int f, bool solid, (int LoopIndex, bool IsHole)[] loops) when v > 0 && e > 0 && f > 0 && solid && (e - v - f + 2) / 2 is int genus && genus >= 0 => ResultFactory.Create(value: (genus, loops, solid, genus)),
                    (int v, int e, int f, bool solid, (int LoopIndex, bool IsHole)[] loops) when v > 0 && e > 0 && f > 0 => ResultFactory.Create(value: (0, loops, solid, 0)),

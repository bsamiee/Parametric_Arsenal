...
internal static class TopologyCompute {
    ...
    internal static Result<IReadOnlyList<Point3d>> GetEdgeMidpoints(GeometryBase geometry) {
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static Result<IReadOnlyList<Point3d>> GetFaceCentroids(GeometryBase geometry) {
        return geometry switch {
            Brep b => (
                b.Faces
                    .Select(f => {

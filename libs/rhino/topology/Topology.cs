...
public static class Topology {
    ...
    public static Result<TResult> Analyze<TGeometry, TResult>(
        ...
        TopologyCompute.StrategyConfig.TryGetValue((typeof(TGeometry), mode), out (Arsenal.Core.Validation.V validationMode, Func<object, IGeometryContext, object[], Result<IResult>> compute) strategy) switch {

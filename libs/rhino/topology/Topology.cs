...
public static class Topology {
    ...
    public readonly struct EdgeContinuityType(byte value) : IEquatable<EdgeContinuityType> {
        ...
        public byte ToByte() => this._value;
        public static EdgeContinuityType FromByte(byte value) => new(value);
        public static implicit operator byte(EdgeContinuityType type) => type._value;
        public static explicit operator EdgeContinuityType(byte value) => new(value);
        public override bool Equals(object? obj) => obj is EdgeContinuityType other && this._value == other._value;
        public bool Equals(EdgeContinuityType other) => this._value == other._value;
        public override int GetHashCode() => this._value.GetHashCode();
        public static bool operator ==(EdgeContinuityType left, EdgeContinuityType right) => left._value == right._value;
        public static bool operator !=(EdgeContinuityType left, EdgeContinuityType right) => left._value != right._value;
    }

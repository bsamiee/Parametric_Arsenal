...
public static class Topology {
    ...
    public static Result<NakedEdgeData> GetNakedEdges(
        ...
        TopologyEngine.ExecuteNakedEdges(input: geometry, context: context, orderLoops: orderLoops, enableDiagnostics: enableDiagnostics);
    ...
    public static Result<BoundaryLoopData> GetBoundaryLoops(
        ...
        bool enableDiagnostics = false) =>
        TopologyEngine.ExecuteBoundaryLoops(input: geometry, context: context, tolerance: tolerance, enableDiagnostics: enableDiagnostics);
    ...
    public static Result<NonManifoldData> GetNonManifoldData(
        ...
        IGeometryContext context,
        bool enableDiagnostics = false) =>
        TopologyEngine.ExecuteNonManifold(input: geometry, context: context, enableDiagnostics: enableDiagnostics);
    ...
    public static Result<ConnectivityData> GetConnectivity(
        ...
        IGeometryContext context,
        bool enableDiagnostics = false) =>
        TopologyEngine.ExecuteConnectivity(input: geometry, context: context, enableDiagnostics: enableDiagnostics);
    ...
    public static Result<EdgeClassificationData> ClassifyEdges(
        ...
        bool enableDiagnostics = false) =>
        TopologyEngine.ExecuteEdgeClassification(input: geometry, context: context, minimumContinuity: minimumContinuity, enableDiagnostics: enableDiagnostics);
    ...
    public static Result<EdgeClassificationData> ClassifyEdges(
        ...
        bool enableDiagnostics = false) =>
        TopologyEngine.ExecuteEdgeClassification(input: geometry, context: context, angleThreshold: angleThreshold, enableDiagnostics: enableDiagnostics);
    ...
    public static Result<AdjacencyData> GetAdjacency(
        ...
        int edgeIndex,
        bool enableDiagnostics = false) =>
        TopologyEngine.ExecuteAdjacency(input: geometry, context: context, edgeIndex: edgeIndex, enableDiagnostics: enableDiagnostics);

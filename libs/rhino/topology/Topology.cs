...
public static class Topology {
    ...
    public static Result<TResult> Analyze<TGeometry, TResult>(
        ...
        TopologyCompute.StrategyConfig.TryGetValue((typeof(TGeometry), mode), out (Core.Validation.V validationMode, System.Func<object, IGeometryContext, object[], Result<IResult>> compute) strategy) switch {
            true => UnifiedOperation.Apply(
                input: geometry,
                operation: (System.Func<TGeometry, Result<IReadOnlyList<IResult>>>)(g => strategy.compute(g, context, args).Map(r => (IReadOnlyList<IResult>)[r,])),

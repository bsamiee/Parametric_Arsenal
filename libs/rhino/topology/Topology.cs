...
public static class Topology {
    ...
    public static Result<TopologyDiagnosis> DiagnoseTopology(
        Brep brep,
        IGeometryContext context) =>
        TopologyCore.ExecuteDiagnose(brep: brep, context: context);
    ...
    public static Result<TopologicalFeatures> ExtractTopologicalFeatures(
        Brep brep,
        IGeometryContext context) =>
        TopologyCore.ExecuteExtractFeatures(brep: brep, context: context);
    ...
    public static Result<HealingResult> HealTopology(
        ...
        IGeometryContext context) =>
        TopologyCore.ExecuteHeal(brep: brep, strategies: strategies, context: context);
}

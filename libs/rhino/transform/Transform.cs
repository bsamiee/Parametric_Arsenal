...
public static class Transform {
    ...
    public readonly record struct TransformSpec {
        ...
        [Pure]
        public static TransformSpec FromRotate(double angle, Vector3d axis, Point3d center) => new() { Rotation = (angle, axis, center) };
        /// <summary>Create rotation from vector to vector specification.</summary>
        [Pure]
        public static TransformSpec FromRotate(Vector3d start, Vector3d end, Point3d center) => new() { RotationVectors = (start, end, center) };
        ...
        [Pure]
        public static TransformSpec FromTranslate(Vector3d motion) => new() { Translation = motion };
        ...
        [Pure]
        public static TransformSpec FromProject(Plane plane) => new() { ProjectionPlane = plane };
    ...
    public static Result<T> Rotate<T>(
        ...
        Point3d center,
        IGeometryContext context) where T : GeometryBase =>
        Apply(geometry: geometry, spec: TransformSpec.FromRotate(angleRadians, axis, center), context: context);
    ...
    public static Result<T> Rotate<T>(
        ...
        Point3d center,
        IGeometryContext context) where T : GeometryBase =>
        Apply(geometry: geometry, spec: TransformSpec.FromRotate(startDirection, endDirection, center), context: context);
    ...
    public static Result<T> Translate<T>(
        ...
        Vector3d motion,
        IGeometryContext context) where T : GeometryBase =>
        Apply(geometry: geometry, spec: TransformSpec.FromTranslate(motion), context: context);
    ...
    public static Result<T> Translate<T>(
        ...
        Point3d end,
        IGeometryContext context) where T : GeometryBase =>
        Apply(geometry: geometry, spec: TransformSpec.FromTranslate(end - start), context: context);
    ...
    public static Result<T> Project<T>(
        ...
        Plane plane,
        IGeometryContext context) where T : GeometryBase =>
        Apply(geometry: geometry, spec: TransformSpec.FromProject(plane), context: context);

# FieldsCore.cs - Dispatch and Grid Sampling Blueprint
...
## Type Count
**2 types**: 
1. `FieldsCore` (internal static class - dispatch registry)
...
## Integration Points
- **Fields**: Calls OperationRegistry.TryGetValue for dispatch
- **FieldsConfig**: Reads constants (OperationDistance, MinResolution, DistanceFieldRTreeThreshold)
- **FieldsCompute**: Uses SampleGrid and DistanceQuery structs

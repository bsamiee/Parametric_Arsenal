...
internal static class OrientConfig {
    /// <summary>Validation modes per geometry type for orientation operations.</summary>
    ...
    /// <summary>Tolerance defaults for degenerate frame and vector checks.</summary>

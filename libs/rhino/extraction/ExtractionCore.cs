...
#pragma warning restore IDE0004
        ...
        try {
            V mode = ExtractConfig.ValidationModes.TryGetValue((kind, normalized.GetType()), out V exact) ? exact :
                ExtractConfig.ValidationModes.Where(kv => kv.Key.Item1 == kind && kv.Key.Item2.IsInstanceOfType(normalized))

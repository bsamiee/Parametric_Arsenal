...
public static class Intersect {
    ...
    public static Result<IntersectionOutput> Execute<T1, T2>(
        ...
        Type elementType = t1Type is { IsGenericType: true } t && t.GetGenericTypeDefinition() == typeof(IReadOnlyList<>)
            ...
            : t1Type;
        ValidationConfig mode = IntersectionCore._validationConfig.TryGetValue((t1Type, t2Type), out ValidationConfig m1) ? m1
            : IntersectionCore._validationConfig.TryGetValue((elementType, t2Type), out ValidationConfig m2) ? m2
    ...
    private static class IntersectionCore {
        internal static readonly FrozenDictionary<(Type, Type), ValidationConfig> _validationConfig =
            new Dictionary<(Type, Type), ValidationConfig> {
                [(typeof(Curve), typeof(Curve))] = ValidationConfig.Standard | ValidationConfig.Degeneracy,
                [(typeof(Curve), typeof(Surface))] = ValidationConfig.Standard,
                [(typeof(Curve), typeof(Brep))] = ValidationConfig.Standard | ValidationConfig.Topology,
                [(typeof(Curve), typeof(BrepFace))] = ValidationConfig.Standard | ValidationConfig.Topology,
                [(typeof(Curve), typeof(Plane))] = ValidationConfig.Standard | ValidationConfig.Degeneracy,
                [(typeof(Curve), typeof(Line))] = ValidationConfig.Standard | ValidationConfig.Degeneracy,
                [(typeof(Brep), typeof(Brep))] = ValidationConfig.Standard | ValidationConfig.Topology,
                [(typeof(Brep), typeof(Plane))] = ValidationConfig.Standard | ValidationConfig.Topology,
                [(typeof(Brep), typeof(Surface))] = ValidationConfig.Standard | ValidationConfig.Topology,
                [(typeof(Surface), typeof(Surface))] = ValidationConfig.Standard,
                [(typeof(Mesh), typeof(Mesh))] = ValidationConfig.MeshSpecific,
                [(typeof(Mesh), typeof(Ray3d))] = ValidationConfig.MeshSpecific,
                [(typeof(Mesh), typeof(Plane))] = ValidationConfig.MeshSpecific,
                [(typeof(Mesh), typeof(Line))] = ValidationConfig.MeshSpecific,
                [(typeof(Mesh), typeof(PolylineCurve))] = ValidationConfig.MeshSpecific,
                [(typeof(Line), typeof(Line))] = ValidationConfig.Standard,
                [(typeof(Line), typeof(BoundingBox))] = ValidationConfig.Standard,
                [(typeof(Line), typeof(Plane))] = ValidationConfig.Standard,
                [(typeof(Line), typeof(Sphere))] = ValidationConfig.Standard,
                [(typeof(Line), typeof(Cylinder))] = ValidationConfig.Standard,
                [(typeof(Line), typeof(Circle))] = ValidationConfig.Standard,
                [(typeof(Plane), typeof(Plane))] = ValidationConfig.Standard,
                [(typeof(ValueTuple<Plane, Plane>), typeof(Plane))] = ValidationConfig.Standard,
                [(typeof(Plane), typeof(Circle))] = ValidationConfig.Standard,
                [(typeof(Plane), typeof(Sphere))] = ValidationConfig.Standard,
                [(typeof(Plane), typeof(BoundingBox))] = ValidationConfig.Standard,
                [(typeof(Sphere), typeof(Sphere))] = ValidationConfig.Standard,
                [(typeof(Circle), typeof(Circle))] = ValidationConfig.Standard,
                [(typeof(Arc), typeof(Arc))] = ValidationConfig.Standard,
                [(typeof(Point3d[]), typeof(Brep[]))] = ValidationConfig.Standard | ValidationConfig.Topology,
                [(typeof(Point3d[]), typeof(Mesh[]))] = ValidationConfig.MeshSpecific,
                [(typeof(Ray3d), typeof(GeometryBase[]))] = ValidationConfig.Standard,
            }.ToFrozenDictionary();
...
#pragma warning restore IDISP007
            ...
            static Result<IntersectionOutput> fromPolylines(Polyline[]? sections) =>
                sections switch { { Length: > 0 } => ResultFactory.Create(value: new IntersectionOutput(
                                      ...
                                      [], [], [], [],
                                      [.. sections])),
                    null => ResultFactory.Create<IntersectionOutput>(error: ErrorRegistry.Geometry.IntersectionComputationFailed),
                    _ => ResultFactory.Create(value: IntersectionOutput.Empty),
                };
            ...
            return (a, b, opts) switch {
                (Point3d[] pts, Brep[] breps, { ProjectionDirection: Vector3d dir }) when !dir.IsValid || dir.Length <= RhinoMath.ZeroTolerance =>
                    ResultFactory.Create<IntersectionOutput>(error: ErrorRegistry.Geometry.IntersectionInvalidProjectionDirection),
                ...
                (Ray3d ray, GeometryBase[] geoms, { MaxHits: int hits }) when ray.Direction.Length <= RhinoMath.ZeroTolerance =>
                    ResultFactory.Create<IntersectionOutput>(error: ErrorRegistry.Geometry.IntersectionInvalidRayDirection),
                (Ray3d ray, GeometryBase[] geoms, { MaxHits: int hits }) when hits <= 0 =>
                    ResultFactory.Create<IntersectionOutput>(error: ErrorRegistry.Geometry.IntersectionInvalidMaxHitCount),
...
#pragma warning restore IDISP004
                ...
                (Mesh ma, Line lb, { Sorted: true }) =>
                    RhinoIntersect.MeshLineSorted(ma, lb, out int[] ids3) switch {
                        ...
                        _ => ResultFactory.Create<IntersectionOutput>(error: ErrorRegistry.Geometry.IntersectionComputationFailed),
                    },
                ...
                _ => ResultFactory.Create<IntersectionOutput>(error: ErrorRegistry.Geometry.IntersectionUnsupportedMethod),
            };
        }
    }
}

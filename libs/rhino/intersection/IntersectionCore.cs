...
#pragma warning restore IDISP007
        ...
        static Result<Intersect.IntersectionOutput> fromGeometry((bool success, Curve[] curves, Point3d[] points) r) =>
            (r.success, r.curves.Length, r.points.Length) switch {
                (true, > 0, > 0) => ResultFactory.Create(value: new Intersect.IntersectionOutput([.. r.points], [.. r.curves], [], [], [], [])),
                (true, > 0, _) => ResultFactory.Create(value: new Intersect.IntersectionOutput([], [.. r.curves], [], [], [], [])),
                (true, _, > 0) => ResultFactory.Create(value: new Intersect.IntersectionOutput([.. r.points], [], [], [], [], [])),
                _ => ResultFactory.Create(value: Intersect.IntersectionOutput.Empty),
            };
        ...
        static Result<Intersect.IntersectionOutput> fromPoints((int count, Point3d p1, Point3d p2, double[] parameters, double tolerance) d) =>
            (d.count, d.p1.DistanceTo(d.p2) > d.tolerance, d.parameters.Length) switch {
                ( > 1, true, 2) => ResultFactory.Create(value: new Intersect.IntersectionOutput([d.p1, d.p2], [], [d.parameters[0], d.parameters[1]], [], [], [])),
                ( > 1, true, 0) => ResultFactory.Create(value: new Intersect.IntersectionOutput([d.p1, d.p2], [], [], [], [], [])),
                ( > 0, _, 1) => ResultFactory.Create(value: new Intersect.IntersectionOutput([d.p1], [], [d.parameters[0]], [], [], [])),
                ( > 0, _, 0) => ResultFactory.Create(value: new Intersect.IntersectionOutput([d.p1], [], [], [], [], [])),
                _ => ResultFactory.Create(value: Intersect.IntersectionOutput.Empty),
            };
...
#pragma warning disable IDISP004 // Don't ignore created IDisposable - ownership transferred to caller via result
                1 => ResultFactory.Create(value: new Intersect.IntersectionOutput([], [new ArcCurve(data.circle)], [], [], [], [])),
#pragma warning restore IDISP004
                2 => ResultFactory.Create(value: new Intersect.IntersectionOutput([data.circle.Center], [], [], [], [], [])),
                _ => ResultFactory.Create(value: Intersect.IntersectionOutput.Empty),
            };

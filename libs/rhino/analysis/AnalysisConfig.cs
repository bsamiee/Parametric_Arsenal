...
internal static class AnalysisConfig {
    ...
    /// <summary>Mesh FEA aspect ratio warning threshold.</summary>
    internal const double AspectRatioWarning = 3.0;

    /// <summary>Mesh FEA aspect ratio critical threshold.</summary>
    internal const double AspectRatioCritical = 10.0;

    /// <summary>Mesh FEA skewness warning threshold.</summary>
    internal const double SkewnessWarning = 0.5;

    /// <summary>Mesh FEA skewness critical threshold.</summary>
    internal const double SkewnessCritical = 0.85;

    /// <summary>Mesh FEA Jacobian determinant warning threshold.</summary>
    internal const double JacobianWarning = 0.3;

    /// <summary>Mesh FEA Jacobian determinant critical threshold.</summary>
    internal const double JacobianCritical = 0.1;

    /// <summary>Ideal interior angle for triangle elements in degrees.</summary>
    internal const double TriangleIdealAngleDegrees = 60.0;

    /// <summary>Ideal interior angle for quadrilateral elements in degrees.</summary>

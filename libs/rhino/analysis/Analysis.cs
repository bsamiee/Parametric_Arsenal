...
public static class Analysis {
    ...
    public static Result<CurvatureExtremaData> AnalyzeCurvatureExtrema(
        ...
        IGeometryContext context,
        bool enableDiagnostics = false) =>
        AnalysisCore.ExecuteCurvatureExtrema(curve: curve, context: context, _: enableDiagnostics);
    ...
    public static Result<MultiFaceBrepData> AnalyzeAllFaces(
        ...
        int derivativeOrder = 2,
        bool enableDiagnostics = false) =>
        AnalysisCore.ExecuteMultiFaceBrep(brep: brep, context: context, uvParameter: uvParameter, derivativeOrder: derivativeOrder, _: enableDiagnostics);
    ...
    public static Result<IReadOnlyList<CurveData>> AnalyzeAt(
        ...
        int derivativeOrder = 2,
        bool enableDiagnostics = false) =>
        AnalysisCore.ExecuteBatchCurve(curve: curve, context: context, parameters: parameters, derivativeOrder: derivativeOrder, _: enableDiagnostics);
    ...
    public static Result<IReadOnlyList<SurfaceData>> AnalyzeAt(
        ...
        int derivativeOrder = 2,
        bool enableDiagnostics = false) =>
        AnalysisCore.ExecuteBatchSurface(surface: surface, context: context, uvParameters: uvParameters, derivativeOrder: derivativeOrder, _: enableDiagnostics);
}

...
public static class Analysis {
    ...
    public static Result<CurveData> Analyze(
        ...
        AnalysisEngine.Execute(curve, context, t: parameter, uv: null, index: null, testPoint: null, derivativeOrder: derivativeOrder, enableDiagnostics: enableDiagnostics)
    ...
    public static Result<SurfaceData> Analyze(
        ...
        int derivativeOrder = 2,
        bool enableDiagnostics = false) =>
        AnalysisEngine.Execute(surface, context, t: null, uv: uvParameter, index: null, testPoint: null, derivativeOrder: derivativeOrder, enableDiagnostics: enableDiagnostics)
    ...
    public static Result<BrepData> Analyze(
        ...
        int derivativeOrder = 2,
        bool enableDiagnostics = false) =>
        AnalysisEngine.Execute(brep, context, t: null, uv: uvParameter, index: faceIndex, testPoint: testPoint, derivativeOrder: derivativeOrder, enableDiagnostics: enableDiagnostics)
    ...
    public static Result<MeshData> Analyze(
        ...
        int vertexIndex = 0,
        bool enableDiagnostics = false) =>
        AnalysisEngine.Execute(mesh, context, t: null, uv: null, index: vertexIndex, testPoint: null, derivativeOrder: 0, enableDiagnostics: enableDiagnostics)
    ...
    public static Result<IReadOnlyList<IResult>> AnalyzeMultiple<T>(
        ...
        UnifiedOperation.Apply(
            ...
            (Func<object, Result<IReadOnlyList<IResult>>>)(item =>
                AnalysisEngine.Execute(item, context, parameter, uvParameter, index, testPoint, derivativeOrder, enableDiagnostics: enableDiagnostics)),

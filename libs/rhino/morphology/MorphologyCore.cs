...
internal static class MorphologyCore {
    ...
    internal static Func<GeometryBase, Morphology.MorphologyRequest, IGeometryContext, Result<IReadOnlyList<Morphology.MorphologyResult>>>? GetRequestHandler(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteCageDeform(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not (Mesh or Brep), _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh or Brep")),
            (_, not Morphology.CageDeformation cage) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
            ...
            (GeometryBase geom, Morphology.CageDeformation c) => MorphologyCompute.CageDeform(geom, c.Cage, c.OriginalControlPoints, c.DeformedControlPoints, context)
                .Bind(deformed => {
                    ...
                    return ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteSubdivision(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.SubdivisionRequest sub) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
            ...
            (Mesh mesh, Morphology.SubdivisionRequest s) when MorphologyConfig.RequiresTriangulatedMesh(s) && mesh.Faces.TriangleCount != mesh.Faces.Count =>
                ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteSmoothLaplacian(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.LaplacianSmoothing lap) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteSmoothTaubin(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.TaubinSmoothing tau) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InsufficientParameters.WithContext($"Expected: TaubinSmoothing")),
            (Mesh mesh, Morphology.TaubinSmoothing t) when t.Mu >= -t.Lambda => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
            ...
            (Mesh mesh, Morphology.TaubinSmoothing t) => MorphologyCompute.SmoothWithConvergence(
                    mesh, t.Iterations, lockBoundary: false, (m, pos, _) =>
                        pos.Zip(LaplacianUpdate(m, pos, useCotangent: false), static (p, s) => (p, s))
                            .Select(x => x.p + (t.Lambda * (x.s - x.p)))
                            .ToArray() is Point3d[] blended1
                            ? blended1.Zip(LaplacianUpdate(m, blended1, useCotangent: false), static (b, s) => (b, s))
                                .Select(x => x.b + (t.Mu * (x.s - x.b)))
                                .ToArray()
                            : pos, context)
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteMeanCurvature(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.MeanCurvatureEvolution mce) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteOffset(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.MeshOffsetRequest off) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteReduce(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.MeshReduction red) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteRemesh(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.IsotropicRemeshing rem) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteMeshRepair(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.MeshRepairRequest rep) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteMeshSeparate(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.MeshSeparation) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteMeshWeld(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.MeshWelding weld) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteBrepToMesh(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Brep, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Brep")),
            (_, not Morphology.BrepConversion conv) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteMeshThicken(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.MeshThickening thick) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ExecuteMeshUnwrap(
        GeometryBase input,
        Morphology.MorphologyRequest request,
        IGeometryContext context) =>
        (input, request) switch {
            (not Mesh, _) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
                error: E.Geometry.InvalidGeometryType.WithContext($"Expected: Mesh")),
            (_, not Morphology.MeshUnwrapping unwrap) => ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeSubdivisionMetrics(
        Mesh original,
        Mesh subdivided,
        IGeometryContext context) {
        (double[] edgeLengths, double[] aspectRatios, double[] minAngles) = ComputeMeshMetrics(subdivided, context);
        return ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(value: [
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeSmoothingMetrics(
        Mesh original,
        Mesh smoothed,
        int iterations,
        IGeometryContext context) =>
        Enumerable.Range(0, Math.Min(original.Vertices.Count, smoothed.Vertices.Count))
            ...
            ? ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(value: [
            ...
            : ResultFactory.Create<IReadOnlyList<Morphology.MorphologyResult>>(error: E.Geometry.InvalidCount);

    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeOffsetMetrics(
        Mesh original,
        Mesh offset,
        double _,
        IGeometryContext context) =>
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeReductionMetrics(
        Mesh original,
        Mesh reduced,
        IGeometryContext context) {
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeRemeshMetrics(
        Mesh original,
        Mesh remeshed,
        double targetEdge,
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeRepairMetrics(
        Mesh original,
        Mesh repaired,
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeSeparationMetrics(
        Mesh[] components,
        IGeometryContext _) =>
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeWeldMetrics(
        Mesh original,
        Mesh welded,
        double tolerance,
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeBrepToMeshMetrics(
        Brep brep,
        Mesh mesh,
        IGeometryContext context) {
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeThickenMetrics(
        Mesh original,
        Mesh thickened,
        double thickness,
        bool solidify,
    ...
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static Result<IReadOnlyList<Morphology.MorphologyResult>> ComputeUnwrapMetrics(
        Mesh original,
        Mesh unwrapped,
        IGeometryContext _) {

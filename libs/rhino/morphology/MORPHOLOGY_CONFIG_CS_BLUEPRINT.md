# MorphologyConfig.cs - Configuration and Constants Blueprint
...
## Type Count
**1 type**: `MorphologyConfig` (internal static class)
...
/// <summary>Configuration constants, byte operation codes, and dispatch tables for morphology operations.</summary>
[Pure]
...
## Integration Points
- **Morphology**: Public API reads constants (DefaultResolution, OperationDistance)
- **MorphologyCore**: Reads ValidationModes and BufferSizes for dispatch
- **MorphologyCompute**: Reads RK4Weights, GradientFiniteDifferenceStep, MarchingCubesTable
- **V flags**: Validation mode combinations from Arsenal.Core.Validation

## Verification
`grep -r "enum " MorphologyConfig.cs` MUST return zero matches.

...
internal static class SpatialCore {
    ...
    internal static readonly FrozenDictionary<(Type Input, Type Query), (Func<object, RTree>? Factory, V Mode, int BufferSize, Func<object, object, IGeometryContext, int, Result<IReadOnlyList<int>>> Execute)> OperationRegistry =
        new Dictionary<(Type, Type), (Func<object, RTree>?, V, int, Func<object, object, IGeometryContext, int, Result<IReadOnlyList<int>>>)> {
            [(typeof(Point3d[]), typeof(Sphere))] = (_pointArray, SpatialConfig.ValidationModes[typeof(Point3d[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Point3d[]>(_pointArray)),
            [(typeof(Point3d[]), typeof(BoundingBox))] = (_pointArray, SpatialConfig.ValidationModes[typeof(Point3d[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Point3d[]>(_pointArray)),
            [(typeof(Point3d[]), typeof((Point3d[], int)))] = (_pointArray, SpatialConfig.ValidationModes[typeof(Point3d[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Point3d[]>(_pointArray, (RTree.Point3dKNeighbors, RTree.Point3dClosestPoints))),
            [(typeof(Point3d[]), typeof((Point3d[], double)))] = (_pointArray, SpatialConfig.ValidationModes[typeof(Point3d[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Point3d[]>(_pointArray, (RTree.Point3dKNeighbors, RTree.Point3dClosestPoints))),
            [(typeof(PointCloud), typeof(Sphere))] = (_pointCloud, SpatialConfig.ValidationModes[typeof(PointCloud)], SpatialConfig.DefaultBufferSize, MakeExecutor<PointCloud>(_pointCloud)),
            [(typeof(PointCloud), typeof(BoundingBox))] = (_pointCloud, SpatialConfig.ValidationModes[typeof(PointCloud)], SpatialConfig.DefaultBufferSize, MakeExecutor<PointCloud>(_pointCloud)),
            [(typeof(PointCloud), typeof((Point3d[], int)))] = (_pointCloud, SpatialConfig.ValidationModes[typeof(PointCloud)], SpatialConfig.DefaultBufferSize, MakeExecutor<PointCloud>(_pointCloud, (RTree.PointCloudKNeighbors, RTree.PointCloudClosestPoints))),
            [(typeof(PointCloud), typeof((Point3d[], double)))] = (_pointCloud, SpatialConfig.ValidationModes[typeof(PointCloud)], SpatialConfig.DefaultBufferSize, MakeExecutor<PointCloud>(_pointCloud, (RTree.PointCloudKNeighbors, RTree.PointCloudClosestPoints))),
            [(typeof(Mesh), typeof(Sphere))] = (_mesh, SpatialConfig.ValidationModes[typeof(Mesh)], SpatialConfig.DefaultBufferSize, MakeExecutor<Mesh>(_mesh)),
            [(typeof(Mesh), typeof(BoundingBox))] = (_mesh, SpatialConfig.ValidationModes[typeof(Mesh)], SpatialConfig.DefaultBufferSize, MakeExecutor<Mesh>(_mesh)),
            [(typeof((Mesh, Mesh)), typeof(double))] = (null, SpatialConfig.ValidationModes[typeof(Mesh)], SpatialConfig.LargeBufferSize, MakeMeshOverlapExecutor(_mesh)),
            [(typeof(Curve[]), typeof(Sphere))] = (_curve, SpatialConfig.ValidationModes[typeof(Curve[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Curve[]>(_curve)),
            [(typeof(Curve[]), typeof(BoundingBox))] = (_curve, SpatialConfig.ValidationModes[typeof(Curve[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Curve[]>(_curve)),
            [(typeof(Surface[]), typeof(Sphere))] = (_surface, SpatialConfig.ValidationModes[typeof(Surface[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Surface[]>(_surface)),
            [(typeof(Surface[]), typeof(BoundingBox))] = (_surface, SpatialConfig.ValidationModes[typeof(Surface[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Surface[]>(_surface)),
            [(typeof(Brep[]), typeof(Sphere))] = (_brep, SpatialConfig.ValidationModes[typeof(Brep[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Brep[]>(_brep)),
            [(typeof(Brep[]), typeof(BoundingBox))] = (_brep, SpatialConfig.ValidationModes[typeof(Brep[])], SpatialConfig.DefaultBufferSize, MakeExecutor<Brep[]>(_brep)),
        }.ToFrozenDictionary();

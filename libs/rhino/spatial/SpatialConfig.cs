...
internal static class SpatialConfig {
    ...
    /// <summary>Type extractors: polymorphic dispatch leveraging SDK mass properties and RTree factories.</summary>
    internal static readonly FrozenDictionary<(string Operation, Type GeometryType), Func<object, object>> TypeExtractors =
        new Dictionary<(string, Type), Func<object, object>> {
            // SDK AreaMassProperties/VolumeMassProperties for accurate centroids, fallback to BoundingBox.Center
            ...
            // SDK RTree.Create* methods: optimized spatial indexing for points, clouds, and mesh faces
